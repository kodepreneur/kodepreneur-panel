...
if (__VLS_ctx.logs.data.length === 0) {
    ...
    for (const [log] of __VLS_getVForSourceType((__VLS_ctx.logs.data))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 font-semibold text-slate-900 dark:text-surface-200" },
        });
        (log.action);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 text-slate-600 dark:text-surface-400 font-sans" },
        });
        (log.user_email || 'system');
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 text-slate-500 dark:text-surface-500" },
        });
        (log.ip_address);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...
        (log.status);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 text-slate-400 dark:text-surface-500 text-right" },
        });
