...
if (__VLS_ctx.deployments.data.length === 0) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.thead, __VLS_intrinsicElements.thead)({
        ...{ class: "bg-slate-50 dark:bg-surface-950/40 text-slate-500 dark:text-surface-400 uppercase text-[10px] tracking-wider border-b border-slate-200/80 dark:border-surface-800" },
    });
    ...
    for (const [deploy] of __VLS_getVForSourceType((__VLS_ctx.deployments.data))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 font-mono font-medium text-slate-900 dark:text-white" },
        });
        (deploy.id);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4" },
        ...
        var __VLS_11;
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 font-mono text-[11px] text-slate-600 dark:text-surface-300" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
            ...{ class: "px-2 py-0.5 rounded-md bg-slate-100 dark:bg-surface-800 border border-slate-200 dark:border-surface-700" },
        });
        (deploy.branch);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3.5 px-4 text-slate-500 dark:text-surface-400" },
        });
