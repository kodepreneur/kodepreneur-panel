...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex items-center gap-2 bg-surface-900 border border-surface-800 rounded-xl px-3 py-1.5" },
});
const __VLS_4 = {}.Globe;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "p-3.5 bg-surface-950/60 border-b border-surface-800 flex items-center justify-between gap-3 text-xs" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex items-center gap-2 font-mono text-surface-300 overflow-x-auto" },
});
...
if (__VLS_ctx.files.length === 0) {
    ...
    for (const [file] of __VLS_getVForSourceType((__VLS_ctx.files))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3 px-4 font-mono font-medium text-white" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3 px-4 font-mono text-[11px] text-surface-400" },
        });
        (file.is_dir ? '—' : __VLS_ctx.formatBytes(file.size_bytes));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3 px-4 font-mono text-[10px] text-surface-500" },
        });
        (file.permissions);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "py-3 px-4 font-mono text-[11px] text-surface-500" },
        });
...
if (__VLS_ctx.isEditorOpen) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "w-full max-w-4xl h-[80vh] flex flex-col rounded-2xl bg-surface-900 border border-surface-800 shadow-2xl overflow-hidden" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "h-12 bg-surface-950 border-b border-surface-800 px-4 flex items-center justify-between shrink-0" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "flex items-center gap-2 font-mono text-xs text-white" },
    });
    const __VLS_32 = {}.Code;
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "flex-1 bg-surface-950 p-4 font-mono text-xs text-surface-200 overflow-auto" },
    });
