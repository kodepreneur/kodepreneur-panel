...
import { Save, ArrowUpCircle, ChevronRight } from 'lucide-vue-next';
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "w-10 h-10 rounded-xl bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400 border border-brand-200 dark:border-brand-500/20 flex items-center justify-center group-hover:scale-105 transition" },
});
const __VLS_8 = {}.ArrowUpCircle;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.h3, __VLS_intrinsicElements.h3)({
    ...{ class: "text-xs font-semibold text-slate-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-300 transition" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...{ class: "px-2 py-0.5 rounded-full text-[10px] font-mono bg-brand-50 text-brand-700 border border-brand-200 dark:bg-brand-500/20 dark:text-brand-400 dark:border-brand-500/30" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
    ...{ class: "text-[11px] text-slate-500 dark:text-surface-400 mt-0.5" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex items-center gap-1 text-xs text-brand-600 dark:text-brand-400 font-medium" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
    ...{ class: "text-[11px] text-slate-500 dark:text-surface-500 mt-1" },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "flex items-center justify-end pt-4 border-t border-slate-100 dark:border-surface-800" },
});
...
/** @type {__VLS_StyleScopedClasses['dark:from-brand-950/50']} */ ;
/** @type {__VLS_StyleScopedClasses['dark:via-surface-900/80']} */ ;
/** @type {__VLS_StyleScopedClasses['dark:to-surface-900/80']} */ ;
...
/** @type {__VLS_StyleScopedClasses['dark:group-hover:text-brand-300']} */ ;
/** @type {__VLS_StyleScopedClasses['transition']} */ ;
